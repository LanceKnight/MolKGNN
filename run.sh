...
# ChIRoNet
python entry.py --dataset_name 435034 --num_workers 16 --enable_oversampling_with_replacement --warmup_iterations 200 --max_epochs 20 --peak_lr 5e-2 --end_lr 1e-9 --batch_size 17 --node_feature_dim 52 --edge_feature_dim 14 --hidden_dim 32 --output_dim 1 --default_root_dir actual_training_checkpoints --gpus 1