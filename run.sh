...
# DimeNetPP
python entry.py --dataset_name 1798 --num_workers 16 --dataset_path ../../../dataset/ --enable_oversampling_with_replacement --warmup_iterations 200 --max_epochs 20 --peak_lr 1e-4 --end_lr 1e-9 --batch_size 16 --default_root_dir actual_training_checkpoints --gpus 1

# ChIRoNet
# python entry.py --dataset_name 1798 --num_workers 11 --seed 1 --dataset_path ../../../dataset/ --enable_oversampling_with_replacement --warmup_iterations 200 --max_epochs 20 --peak_lr 6.06e-4 --end_lr 1e-9 --default_root_dir actual_training_checkpoints 
