...
#KGNN-quickrun
# python entry.py --dataset_name 9999 --num_workers 16 --dataset_path ../dataset/ --enable_oversampling_with_replacement --warmup_iterations 200 --max_epochs 3 --peak_lr 1e-4 --end_lr 1e-9 --batch_size 16 --default_root_dir actual_training_checkpoints --gpus 1 --train_metric
...
# SphereNet
python entry.py --dataset_name 9999 --num_workers 16 --dataset_path ../dataset/ --enable_oversampling_with_replacement --warmup_iterations 200 --max_epochs 3 --peak_lr 5e-2 --end_lr 1e-9 --batch_size 17 --default_root_dir actual_training_checkpoints --gpus 1