...
def run(folder):
    ...
    print(f'comp:{folder_name_components}')
    dataset = folder_name_components[1]
    run_command(dataset)
   ...
   # Get a list of folders
    ...
    for seed_folder in dataset_folder_list:
        ...
        if not os.path.exists(f'{seed_folder}/kgnn/logs/test_result.log'):
            ...
            result_exists = False
            no_result_folder_list.append(seed_folder)
            break
    ...
    if result_exists:
        ...
        with Pool(processes = 3) as pool:
            pool.map(run, no_result_folder_list)
...
if __name__ == '__main__':
    ...
    model_dir = '/home/liuy69/projects/unified_framework/experiments/shrink_full_comparison/without_valid/fullset'
    ...
    print(f'checking {best_based_on}')
