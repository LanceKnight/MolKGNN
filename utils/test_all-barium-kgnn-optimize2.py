...
def get_table_for_a_metric(use_best, best_based_on, monitored_metric, folder_list, exp_dir):
    ...
    with open(file_name, 'w') as output_file:
        for folder in folder_list:
            ...
            layers = name_components[6]
            decay = name_components[13]
            dropout = name_components[14]
            index_name = f'{dataset_name}_{peak}_{layers}_{decay}_{dropout}'
            # print('\n=======\n')
            try:
...
if __name__ == '__main__':
    ...
    model_dir = '/home/liuy69/projects/unified_framework/experiments/kgnn_optimize2'
