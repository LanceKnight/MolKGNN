...
def get_table_for_a_metric(use_best, best_based_on, monitored_metric, folder_list, exp_dir):
    ...
    with open(file_name, 'w') as output_file:
        for folder in folder_list:
            ...
            dataset_name = name_components[2]
            seed = name_components[4]
...
if __name__ == '__main__':
    ...
    model_dir = '/home/liuy69/projects/unified_framework/experiments/final_schnet'
